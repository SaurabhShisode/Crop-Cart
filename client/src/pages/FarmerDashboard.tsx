    ...
    <>
      ...
      <div className="min-h-screen p-28 bg-green-50">
        ...
        {loading ? (
          ...
          <>
            <div className="grid grid-cols-6 grid-rows-8 gap-4 text-white">
              {/* This Month's Earnings */}
              <div className="col-span-3 row-span-4 bg-green-600 rounded-xl p-4 flex flex-col justify-between shadow-md">
                <div>
              ...
              {/* This Month's Orders */}
              <div className="col-span-3 row-span-4 col-start-1 row-start-4 bg-blue-600 rounded-xl p-4 flex flex-col justify-between shadow-md">
                <div>
              ...
              {/* Most Sold Crop */}
              <div className="col-span-3 row-span-8 col-start-4 row-start-1 bg-yellow-500 rounded-xl p-4 flex flex-col justify-between shadow-md">
