...
const Navbar: React.FC<{
  ...
  setSearchQuery,
    ...
    const placeholders = ["Search for tomatoes...", "Search for onions...", "Search for potatoes..."];
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="flex justify-center">
        <main className="flex-grow max-w-7xl mx-20 min-h-screen py-10 px-4 bg-white">
      ...
      <footer className="bg-green-900 text-green-100 py-6 mt-12">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p className="text-sm">&copy; {new Date().getFullYear()} CropCart. All rights reserved.</p>
          <p className="text-xs mt-1">Made with ❤️ for fresh & local produce lovers.</p>
        </div>
      </footer>


      <div
        className={`fixed top-28 right-0 h-[calc(100vh-8rem)] w-80 bg-white shadow-lg transform transition-transform rounded ${isCartOpen ? 'translate-x-0' : 'translate-x-full'
          }`}
