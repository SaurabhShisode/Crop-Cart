...
const LoginPage: React.FC = () => {
  ...
  {/* Left Panel */}
  <div className="w-full md:w-1/3 relative overflow-hidden flex items-center justify-center bg-green-900 py-10 md:py-0">
    <div className="z-10 text-center px-8 md:px-12">
